...
async def get_networks(
    ...
    return [DhcpNetwork.model_validate(net) for net in networks]
...
async def create_network(
    ...
    return DhcpNetwork.model_validate(db_network)
...
async def get_network(
    ...
    return DhcpNetwork.model_validate(network)
...
async def get_reservations(
    ...
    return [DhcpReservation.model_validate(res) for res in reservations]
...
async def create_reservation(
    ...
    return DhcpReservation.model_validate(db_reservation)
